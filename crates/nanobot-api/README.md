...
Exposes nanobot's agent capabilities via an OpenAI-compatible REST API so that existing
tools and integrations targeting the `/v1/chat/completions` endpoint can use nanobot as
a drop-in backend.
